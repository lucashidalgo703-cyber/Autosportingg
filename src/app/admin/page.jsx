            ...
            <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                    <button 
                        ...
                        className={`appearance-none h-8 px-3 flex items-center gap-1.5 text-xs font-medium rounded-lg transition-colors border ${hideAmounts ? 'bg-crm-red/10 text-crm-red border-crm-red/20 hover:bg-crm-red/20' : 'bg-crm-surface text-crm-fg border-crm-border hover:bg-crm-surface-raised'}`}
                    >
                        {hideAmounts ? (
                            <><Eye size={14} /> Mostrar montos</>
                        ) : (
                            <><EyeOff size={14} /> Ocultar montos</>
                        )}
                    </button>
                </div>
            </div>
