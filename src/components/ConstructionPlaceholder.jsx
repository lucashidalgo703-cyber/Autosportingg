    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center min-h-[70vh] px-6 text-center animate-in fade-in duration-700">
            <motion.div 
                ...
                className="bg-zinc-900/40 p-12 rounded-3xl border border-white/5 max-w-md w-full relative overflow-hidden"
            >
                ...
                <div className="relative z-10">
                    <div className="w-20 h-20 bg-black rounded-2xl mx-auto flex items-center justify-center border border-white/10 mb-6 shadow-2xl">
