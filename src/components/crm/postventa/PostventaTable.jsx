            ...
            <table className="w-full text-left border-collapse">
                <thead>
                    <tr className="border-b border-[#33333A] bg-[#1E1E24]">
                        <th className="p-4 text-xs font-bold text-[#A1A1AA] uppercase tracking-wider">Fecha Entrega</th>
                        ...
                        <th className="p-4 text-xs font-bold text-[#A1A1AA] uppercase tracking-wider">Checklist</th>
