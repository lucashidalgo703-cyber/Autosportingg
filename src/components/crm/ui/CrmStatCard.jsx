...
export default function CrmStatCard({ title, value, prefix = '', suffix = '', trend, trendValue }) {
    return (
        <div className="bg-crm-surface rounded-2xl border border-crm-border p-5 shadow-lg transition-all hover:-translate-y-0.5 hover:shadow-xl flex flex-col gap-2">
