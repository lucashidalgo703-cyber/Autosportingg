        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl overflow-hidden flex flex-col h-full">
                ...
                <div className="flex gap-2 items-center">
                    {onCreateTask && (
                        <button
                            ...
                            className="h-8 px-3 rounded-lg bg-blue-500/10 hover:bg-[#C42620]/20 text-blue-400 border border-blue-500/20 font-bold text-xs flex items-center justify-center transition-colors"
                        >
                            Crear seguimiento
                        </button>
                    )}
            ...
            <div className="p-4 flex-1 flex flex-col">
                <textarea
                    ...
                    className="flex-1 w-full bg-black/30 border border-neutral-800 rounded-xl p-4 text-sm text-white focus:outline-none focus:border-[#EF3329]/50 transition-colors resize-none custom-scrollbar min-h-[150px]"
                ></textarea>
