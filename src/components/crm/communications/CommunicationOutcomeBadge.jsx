...
export default function CommunicationOutcomeBadge({ outcome, className = '' }) {
    const getOutcomeData = (o) => {
        switch (o) {
            ...
            case 'no_response': return { text: 'Sin Respuesta', color: 'bg-red-500/10 text-red-400 border-red-500/20' };
            case 'interested': return { text: 'Interesado', color: 'bg-green-500/10 text-green-400 border-green-500/20' };
            case 'not_interested': return { text: 'No Interesado', color: 'bg-gray-500/10 text-gray-400 border-gray-500/20' };
            ...
            case 'complaint': return { text: 'Reclamo', color: 'bg-red-600/10 text-red-500 border-red-600/20' };
            case 'resolved': return { text: 'Resuelto', color: 'bg-green-500/20 text-green-500 border-green-500/30 font-bold' };
            case 'other': default: return { text: 'Otro', color: 'bg-gray-600/10 text-gray-400 border-gray-600/20' };
        }
    };
