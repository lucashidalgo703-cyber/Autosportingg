...
export default function CommunicationLogItem({ log }) {
    ...
    return (
        <div className={`bg-crm-surface border ${log.isImportant ? 'border-red-900/50' : 'border-crm-border'} rounded-xl p-4 transition-colors hover:bg-crm-surface-raised`}>
            ...
            {log.notes && (
                <div className="text-xs text-crm-fg-muted bg-crm-bg p-3 rounded-lg border border-crm-border whitespace-pre-wrap mb-3">
