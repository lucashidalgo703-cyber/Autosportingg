...
export default function CommunicationLogForm({ 
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className="bg-crm-bg border border-crm-border rounded-xl shadow-2xl w-full max-w-2xl flex flex-col max-h-[90vh]">
                <div className="flex justify-between items-center p-4 border-b border-crm-border bg-crm-surface rounded-t-xl shrink-0">
                    <h3 className="text-lg font-bold text-white flex items-center gap-2">
                        <MessageCircle size={20} className="text-crm-red" />
                    ...
                    <form id="comm-form" onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <select 
                                    ...
                                    className="w-full bg-crm-surface border border-crm-border text-white text-sm rounded-lg p-2.5 focus:outline-none focus:border-crm-red"
                                >
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                className="w-full bg-crm-surface border border-crm-border text-white text-sm rounded-lg p-2.5 focus:outline-none focus:border-crm-red resize-none"
                            ></textarea>
                        </div>

                        <div className="bg-crm-surface border border-crm-border p-4 rounded-lg">
                            <label className="flex items-center gap-3 cursor-pointer mb-3">
                                <input 
                                    ...
                                    onChange={handleChange}
                                    className="w-4 h-4 rounded border-crm-border bg-crm-surface-raised text-crm-red focus:ring-crm-red"
                                />
                                <span className="text-sm font-bold text-white flex items-center gap-2">
                                    <CalendarIcon size={16} className="text-crm-red" />
                            ...
                            {formData.shouldCreateTask && (
                                <div className="pl-7 mt-2">
                                    ...
                                    <input 
                                        ...
                                        onChange={handleChange}
                                        className="w-full bg-crm-surface-raised border border-crm-border text-white text-sm rounded-lg p-2.5 focus:outline-none focus:border-crm-red"
                        ...
                        <label className="flex items-center gap-3 cursor-pointer">
                            <input 
                                ...
                                onChange={handleChange}
                                className="w-4 h-4 rounded border-crm-border bg-crm-surface-raised text-crm-red focus:ring-red-500"
                            />
                            <span className="text-sm font-bold text-white flex items-center gap-2">
                ...
                <div className="p-4 border-t border-crm-border bg-crm-surface rounded-b-xl flex justify-end gap-3 shrink-0">
                    <button 
                        type="button" 
                        onClick={onClose} 
                        className="px-4 py-2 text-sm font-bold text-crm-fg-muted bg-crm-surface-raised hover:bg-crm-surface-raised rounded-lg transition-colors border border-crm-border"
                    >
                        Cancelar
                    </button>
                    <button 
                        ...
                        form="comm-form"
                        disabled={loading}
                        className="px-4 py-2 text-sm font-bold text-white bg-crm-red hover:bg-crm-red-hover rounded-lg transition-colors flex items-center gap-2 disabled:opacity-50"
                    >
