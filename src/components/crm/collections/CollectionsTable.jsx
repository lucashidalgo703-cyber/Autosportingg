...
import { Calendar, Handshake, Target } from 'lucide-react';
import InstallmentStatusBadge from '../installments/InstallmentStatusBadge';

export default function CollectionsTable({ installments, onEdit, onRegisterPayment }) {
                                ...
                                <tr key={inst._id} className="hover:bg-black/20 transition-colors">
                                    ...
                                    <td className="p-4">
                                        <div className="flex flex-col gap-0.5">
                                            ...
                                            {clientPhone && <span className="text-[10px] text-neutral-500">{clientPhone}</span>}
                                            <span className="text-xs text-neutral-400 truncate max-w-[220px]">{vehicleName} {vehiclePlate && `(${vehiclePlate})`}</span>
                                        </div>
                                    </td>
