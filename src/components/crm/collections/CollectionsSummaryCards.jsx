...
export default function CollectionsSummaryCards({ stats }) {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-[#1E1E24] border border-[#33333A] rounded-2xl p-4 flex flex-col justify-between relative overflow-hidden">
                <div className="flex justify-between items-start mb-4">
                    <span className="text-[#A1A1AA] text-sm font-bold">Estado Cuotas</span>
                </div>
                <div className="flex flex-col gap-2">
                    <div className="flex justify-between items-center bg-black/20 px-3 py-2 rounded-xl">
                        <span className="text-sm text-[#A1A1AA]">Pendientes</span>
                        <span className="text-xl font-bold text-[#FAFAFA]">{stats.cuotasPendientes}</span>
                    </div>
            ...
            <div className="bg-[#1E1E24] border border-[#33333A] rounded-2xl p-4 flex flex-col justify-between relative overflow-hidden">
                <div className="flex justify-between items-start mb-4">
                    <span className="text-[#A1A1AA] text-sm font-bold">Próximos Vencimientos</span>
                </div>
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex justify-between items-center bg-black/20 px-3 py-2 rounded-xl">
                        <span className="text-sm text-[#A1A1AA]">Próximos 7 días</span>
                        <span className="text-xl font-bold text-[#FAFAFA]">{stats.vencen7Dias}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-[#1E1E24] border border-[#33333A] rounded-2xl p-4 flex flex-col justify-between relative overflow-hidden">
                <div className="flex justify-between items-start mb-4">
                    <span className="text-[#A1A1AA] text-sm font-bold">Deuda Activa</span>
                </div>
                <div className="flex flex-col gap-2">
                    <div className="flex justify-between items-center bg-black/20 px-3 py-2 rounded-xl">
                        <span className="text-sm text-[#A1A1AA]">USD</span>
                        <span className="text-lg font-bold text-[#4ade80]">{formatCurrency(stats.pendienteUSD, 'USD')}</span>
                    </div>
                    <div className="flex justify-between items-center bg-black/20 px-3 py-2 rounded-xl">
                        <span className="text-sm text-[#A1A1AA]">ARS</span>
            ...
            <div className="bg-[#1E1E24] border border-[#33333A] rounded-2xl p-4 flex flex-col justify-between relative overflow-hidden">
                <div className="flex justify-between items-start mb-4">
                    <span className="text-[#A1A1AA] text-sm font-bold">Deuda Vencida</span>
                </div>
                <div className="flex flex-col gap-2">
                    <div className="flex justify-between items-center bg-red-500/10 px-3 py-2 rounded-xl border border-red-500/20">
