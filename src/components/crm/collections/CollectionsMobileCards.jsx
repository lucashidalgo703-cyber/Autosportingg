                        ...
                        <div className="flex justify-between items-start">
                            <div className="flex flex-col gap-1">
                                ...
                                {inst.reminderInfo?.status === 'completado' && (
                                    <span className="text-[9px] text-green-400 bg-green-400/10 px-1.5 py-0.5 rounded border border-green-400/20 w-max flex items-center gap-1 mt-1">
                                        <Bell size={8} /> Recordatorio completado
                                    </span>
                                )}
                                {inst.reminderInfo?.status === 'cancelado' && (
                                    <span className="text-[9px] text-neutral-400 bg-neutral-400/10 px-1.5 py-0.5 rounded border border-neutral-400/20 w-max flex items-center gap-1 mt-1">
                                ...
                                {hasOverdueNoCobroWarning && (
                                    <span className="text-[9px] text-red-400 bg-red-400/10 px-1.5 py-0.5 rounded border border-red-400/20 w-max mt-1">
                                        Vencida sin cobro
                                    </span>
                                )}
                            </div>
