...
export default function ReportsTasksSection({ data }) {
    ...
    const getTypeConfig = (type) => {
        switch(type) {
            case 'cobranza': return { label: 'Cobranzas', icon: Target, color: 'text-red-400', bg: 'bg-red-500/10', border: 'border-red-500/20' };
    ...
    return (
        <div className="bg-[#161619] border border-[#33333A] rounded-2xl p-5">
            <div className="flex items-center gap-2 mb-6 border-b border-[#33333A] pb-4">
                ...
                <span className="ml-auto text-xs font-bold bg-neutral-800 text-white px-2 py-0.5 rounded">Pdtes: {pendientes}</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-3">
                    <div className="bg-[#1E1E24] rounded-xl p-4 flex items-center justify-between border border-[#33333A]">
                        ...
                        <span className="text-xl font-bold text-red-500">{vencidas}</span>
                    </div>
                ...
                <div className="md:col-span-2">
                    ...
                    {activeTypes.length === 0 ? (
                        <div className="text-sm text-neutral-500 italic p-4 bg-[#1E1E24] rounded-xl border border-[#33333A]">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                            {activeTypes.map(([type, count]) => {
                                ...
                                return (
                                    <div key={type} className="bg-[#1E1E24] p-3 rounded-lg border border-[#33333A] flex items-center gap-3">
                    ...
                    <div className="mt-6 pt-4 border-t border-[#33333A] flex items-center gap-4">
