...
export default function ReportsTasksSection({ data }) {
    ...
    return (
        <div className="bg-[#161619] border border-crm-border rounded-2xl p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="flex flex-col gap-3">
                    <div className="bg-[#1E1E24] rounded-xl p-4 flex items-center justify-between border border-crm-border">
                ...
                <div className="md:col-span-2">
                    ...
                    {activeTypes.length === 0 ? (
                        <div className="text-sm text-neutral-500 italic p-4 bg-[#1E1E24] rounded-xl border border-crm-border">
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
                            {activeTypes.map(([type, count]) => {
                                ...
                                return (
                                    <div key={type} className="bg-[#1E1E24] p-3 rounded-lg border border-crm-border flex items-center gap-3">
