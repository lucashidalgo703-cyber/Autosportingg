    ...
    return (
        <div className="bg-[#161619] border border-[#33333A] rounded-2xl p-5 flex flex-col h-full">
            ...
            <div className="grid grid-cols-2 gap-4 flex-1">
                <div className="bg-[#1E1E24] rounded-xl p-3 flex flex-col justify-center items-center border border-[#33333A]">
            ...
            <div className="mt-6 pt-4 border-t border-[#33333A]">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="flex-1 bg-red-500/10 border border-red-500/20 rounded-lg p-2 text-center">
                        <div className="text-lg font-bold text-red-500">{aging90}</div>
