...
export default function ReportsExportPanel({ data, filters }) {
    ...
    return (
        <div className="bg-crm-bg border border-crm-border rounded-2xl p-5 mb-6">
            <div className="flex flex-col md:flex-row justify-between md:items-center gap-4 mb-4">
                ...
                <Link
                    ...
                    target="_blank"
                    className="flex items-center gap-2 px-4 py-2.5 bg-crm-red text-white hover:bg-crm-red-hover rounded-xl text-xs font-bold transition-colors"
                >
            ...
            <div className="flex flex-wrap gap-3">
                <button 
                    ...
                    className="flex items-center gap-2 px-3 py-2 bg-indigo-500/10 hover:bg-crm-red-hover/20 border border-indigo-500/20 text-indigo-400 rounded-xl text-xs font-bold transition-colors"
                >
                    <BarChart3 size={14} /> Resumen Gerencial
                </button>
                <button 
                    onClick={handleExportSales}
                    className="flex items-center gap-2 px-3 py-2 bg-crm-surface hover:bg-crm-surface-raised border border-crm-border text-white rounded-xl text-xs font-bold transition-colors"
                >
