...
export default function ReportsCollectionsSection({ data }) {
    ...
    return (
        <div className="bg-crm-bg border border-crm-border rounded-2xl p-5 flex flex-col h-full">
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-6 flex-1">
                <div className="flex-1 flex flex-col gap-3">
                    <div className="bg-crm-red/10 border border-red-500/20 rounded-xl p-3 flex flex-col justify-center items-center text-center h-full min-h-[100px]">
                        <AlertCircle size={20} className="text-crm-red mb-2" />
                        <div className="text-2xl font-bold text-crm-red">{cuotasVencidas}</div>
                        <div className="text-[10px] text-red-400 font-bold uppercase mt-1">Cuotas Vencidas</div>
                    </div>
                </div>
                
                <div className="flex-1 flex flex-col gap-3 justify-center">
                    <div className="flex justify-between items-center bg-crm-surface p-3 rounded-lg border border-crm-border">
            ...
            <div className="pt-4 border-t border-crm-border flex justify-between gap-4">
