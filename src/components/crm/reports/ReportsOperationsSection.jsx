    ...
    return (
        <div className="bg-[#161619] border border-[#33333A] rounded-2xl p-5 flex flex-col h-full">
            ...
            <div className="flex-1 mb-6">
                <div className="flex items-center gap-2 mb-4 border-b border-[#33333A] pb-3">
            ...
            <div className="flex-1">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="bg-[#1E1E24] p-3 rounded-lg border border-[#33333A] flex flex-col justify-center items-center">
