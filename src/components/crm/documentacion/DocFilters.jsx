...
export default function DocFilters({ filters, setFilters }) {
    ...
    return (
        <div className="bg-crm-bg border border-crm-border rounded-2xl p-4 mb-6">
            <div className="flex flex-col lg:flex-row gap-4">
                ...
                <div className="flex flex-wrap lg:flex-nowrap gap-3">
                    <select
                        ...
                        onChange={handleChange}
                        className="bg-crm-bg border border-crm-border text-crm-fg text-sm rounded-xl px-4 py-2.5 focus:outline-none focus:border-orange-500 min-w-[160px]"
                    >
