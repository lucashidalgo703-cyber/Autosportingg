...
export default function VehicleHistoryTimeline({ vehicle }) {
    ...
    return (
        <CrmCard>
            ...
            {timeline.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-8 text-center bg-[#161619] rounded-xl border border-crm-border border-dashed">
                    ...
                    {timeline.map((item, index) => {
                        ...
                        return (
                            <div key={item._id || index} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                                ...
                                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-[#161619] p-4 rounded-xl border border-crm-border">
                                    ...
                                    {(item.oldValue !== undefined && item.newValue !== undefined && item.action !== 'GASTO') && (
                                        <div className="mt-3 p-2 bg-[#09090B] rounded border border-crm-border grid grid-cols-2 gap-2 text-xs">
