                ...
                <form onSubmit={handleSubmit} className="p-4 flex-1 overflow-y-auto flex flex-col gap-4">
                    ...
                    <div className="pt-4 flex gap-3 mt-auto">
                        ...
                        <button 
                            type="submit" 
                            disabled={isSaving}
                            className="flex-1 px-4 py-2 bg-[#E63027] text-white rounded-lg hover:bg-[#C42620] transition-colors font-medium text-sm flex items-center justify-center gap-2 disabled:opacity-50"
                        >
