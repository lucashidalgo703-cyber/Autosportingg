        ...
        <CrmCard>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-y-6 gap-x-4">
                ...
                <div>
                    ...
                    <span className="text-sm font-mono text-white bg-[#161619] px-2 py-0.5 rounded border border-crm-border w-fit">
                        {vehicle.dominio || 'S/D'}
                    </span>
                </div>
                <div>
            ...
            {vehicle.observaciones && (
                <div className="mt-6 pt-4 border-t border-crm-border">
                    ...
                    <p className="text-sm text-white bg-[#161619] p-3 rounded-lg border border-crm-border m-0">
                        {vehicle.observaciones}
                    </p>
                </div>
            )}
