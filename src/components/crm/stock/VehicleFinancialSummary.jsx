    ...
    return (
        <CrmCard>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="flex flex-col gap-1 p-3 bg-[#161619] rounded-lg border border-crm-border">
            ...
            <div className="mt-6 flex items-center justify-between p-4 bg-[#24242B] rounded-lg border border-crm-border">
                <div>
