    ...
    return (
        <CrmCard>
            ...
            <div className="flex flex-col gap-3">
                <CrmButton onClick={onEdit} className="flex items-center justify-start gap-3 w-full bg-[#161619] border-crm-border hover:bg-[#24242B] text-white">
                ...
                <CrmButton 
                    ...
                    className={`flex items-center justify-start gap-3 w-full border-crm-border ${vehicle?.status === 'Vendido' || vehicle?.status === 'Reservado' || activeReservation?._id ? 'opacity-50 cursor-not-allowed bg-[#24242B] hover:bg-[#24242B]' : 'bg-[#161619] hover:bg-[#24242B] text-white'}`}
                >
                ...
                <CrmButton className="flex items-center justify-start gap-3 w-full opacity-50 cursor-not-allowed bg-[#24242B] border-crm-border hover:bg-[#24242B]">
                    <Handshake size={16} />
                    <div className="flex flex-col items-start text-left">
                        <span>Marcar Vendido</span>
                        <span className="text-[10px] text-crm-fg-muted font-normal">Próxima fase</span>
                    </div>
                </CrmButton>

                <div className="h-px w-full bg-crm-surface-raised my-1"></div>

                <CrmButton onClick={onAddExpense} className="flex items-center justify-start gap-3 w-full bg-[#161619] border-crm-border hover:bg-[#24242B] text-white">
                ...
                <CrmButton className="flex items-center justify-start gap-3 w-full opacity-50 cursor-not-allowed bg-[#24242B] border-crm-border hover:bg-[#24242B]">
                    ...
                    <div className="flex flex-col items-start text-left">
                        ...
                        <span className="text-[10px] text-crm-fg-muted font-normal">Disponible en próxima fase</span>
                    </div>
                </CrmButton>
