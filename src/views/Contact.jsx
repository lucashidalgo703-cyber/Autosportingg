"use client";
import { MapPin, Instagram, MessageCircle, Clock, ArrowUpRight, Send } from 'lucide-react';
  ...
  return (
    <main className="contact-page">
      ...
      <section className="container contact-grid-section">
        ...
        {/* Contenedor Inferior: Mapa + Formulario */}
        <div className="bottom-grid">
            ...
            <p>Dejanos tus datos y un asesor se comunicará con vos a la brevedad.</p>
            ...
            <form onSubmit={handleSubmit} className="contact-form">
                ...
                {isSubmitting ? 'Enviando...' : <><Send size={18} /> Enviar Consulta</>}
                </button>
            </form>
            </motion.div>
      ...
      <style>{`
                ...
                .submit-btn:hover:not(:disabled) {
                    ...
                    box-shadow: 0 10px 20px -10px rgba(235, 38, 40, 0.5);
                }
