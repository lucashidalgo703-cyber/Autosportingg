...
const directoriesToProcess = [
    ...
    'src/components/crm/layout',
    'src/components/crm/agenda',
    'src/components/crm/clients',
    'src/components/crm/communications',
    'src/components/crm/goals',
    'src/components/crm/team',
...
const replacements = [
    ...
    { regex: /bg-neutral-800/g, replacement: 'bg-crm-surface-raised' },
    ...
    { regex: /text-gray-300/g, replacement: 'text-crm-fg-muted' },
    ...
    { regex: /text-red-500/g, replacement: 'text-crm-red' }
];
